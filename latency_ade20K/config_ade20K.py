...
"""Data Dir"""
C.dataset_path = "/home/wangshuo/dou/FasterSeg/"
C.img_root_folder = C.dataset_path
C.gt_root_folder = C.dataset_path
C.train_source = osp.join(C.dataset_path, "ADEChallengeData2016/images/train.txt")
C.eval_source = osp.join(C.dataset_path, "ADEChallengeData2016/images/val.txt")
...
if C.mode == "teacher":
    ...
    C.load_path = "test" # path to the searched directory
    C.teacher_path = "test" # where to load the pretrained teacher's weight
