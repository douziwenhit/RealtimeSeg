...
C.layers = 10 # layers (cells) for supernet6
...
C.FPS_min = [155,] # minimum FPS required for [teacher, student]
C.FPS_max = [175,] # maximum FPS allowed for [teacher, student]
if C.pretrain == True:
    C.batch_size = 4
