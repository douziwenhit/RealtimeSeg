...
C.layers = 10 # layers (cells) for network
""" Train Config """
...
if C.mode =="teacher":
    ...
    C.load_path = "AutoSeg_edge" # path to the searched directory
    ...
    C.teacher_path = "/home/dou/Code/Python/FasterSegFlops/train_tecFuse/train-512x1024_teacher_batch38-20211205-162509"
    C.load_path = "AutoSeg_edge" # path to the searched directory
    C.student_path = "train-512x1024_student_batch36-20211122-103816"
    C.load_epoch = "21" # "last" or "int" (e.g. "30")
    C.batch_size = 36
    C.Fch = 6
    C.image_height = 512
    C.image_width = 1024
...
C.eval_path = "train-512x1024_student_batch36-20211122-103816" # path to pretrained directory to be evaluated
