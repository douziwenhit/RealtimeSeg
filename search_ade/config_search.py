...
"""Data Dir"""
C.dataset_path = "/home/wangshuo/douzi/pytorch-multigpu/"
...
C.eval_height = 512 # real image height
C.eval_width = 512 # real image width
...
C.layers = 12 # layers (cells) for supernet6
